        ...
        <div class="col">
            <table class="table table-striped table-hover">
                ...
                <tbody>
                    ...
                    <?php
                       if($result = mysqli_query($mysqli, "SELECT projects.Id, projects.created_at, projects.name, customers.email_address FROM projects JOIN customers ON projects.customerId=customers.id"))
                       {
